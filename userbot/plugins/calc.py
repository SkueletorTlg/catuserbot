...
async def _(car):
    ...
    if exc:
        ...
        evaluation = "Lo siento, no puedo encontrar el resultado de la ecuación dada"
...
CMD_HELP.update(
    {
      ...
      \n\n📌** CMD ➥** `.calc` tu ecuación :\
      \n**USAGE   ➥  **Resuelve la ecuación matemática dada por la regla de bodmass. "
    }
)
